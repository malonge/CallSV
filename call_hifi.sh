...
$IRIS --pacbio --keep_long_variants --keep_files minimap_path=$MM2 samtools_path=$SAMTOOLS racon_path=$RACON genome_in=$REF vcf_in=$VCF_PREF.f.vcf reads_in=$BAM vcf_out=$VCF_PREF.i.vcf out_dir=$VCF_PREF.iris_out
